...
@protocol ICPImageEngine, ICPEdgeValidator;
...
/** The validator used to filter the rectangles found on view */
@property (nonatomic, strong, nullable) id<ICPEdgeValidator> edgeDetectionValidator;
...
- (instancetype)initWithOriginaImage:(UIImage *)originalImage
                       modifiedImage:(UIImage *)modifiedImage
                         imageEngine:(id<ICPImageEngine>)imageEngine
                           validator:(id<ICPEdgeValidator> _Nullable) edgeDetectionValidator
